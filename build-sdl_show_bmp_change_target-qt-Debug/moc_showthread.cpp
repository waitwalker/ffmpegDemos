...
#include <memory>
#include "../sdl_show_bmp_change_target/showthread.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ShowThread_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ShowThread_t qt_meta_stringdata_ShowThread = {
    {
QT_MOC_LITERAL(0, 10) // "ShowThread"
...
const QMetaObject ShowThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_ShowThread.offsetsAndSize,
    qt_meta_data_ShowThread,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ShowThread_t
, QtPrivate::TypeAndForceComplete<ShowThread, std::true_type>
