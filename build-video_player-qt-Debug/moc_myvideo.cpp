...
#include <memory>
#include "../video_player/myvideo.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MyVideo_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_MyVideo_t qt_meta_stringdata_MyVideo = {
    {
QT_MOC_LITERAL(0, 7) // "MyVideo"
...
const QMetaObject MyVideo::staticMetaObject = { {
    ...
    qt_meta_stringdata_MyVideo.offsetsAndSize,
    qt_meta_data_MyVideo,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MyVideo_t
, QtPrivate::TypeAndForceComplete<MyVideo, std::true_type>
